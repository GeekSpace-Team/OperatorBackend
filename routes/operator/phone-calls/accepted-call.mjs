...
import { getAcceptedCall, getAcceptedCallCount, getMissedCall } from '../../../modules/query/operator-query.mjs';
import { callDirection } from '../../../modules/constant/constant.mjs';

const acceptedCallRouter=express.Router();
acceptedCallRouter.post('/',verifyToken,(req,res) => {
    if(typeof req.body === 'undefined' || req.body == null || typeof req.user === 'undefined' || req.user == null){
        ...
        let query=format(getAcceptedCall,whereQuery,orderByQuery);
