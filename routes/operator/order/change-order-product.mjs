...
import {addOrderProduct, getCourierUniqueId, updateOrderInfo} from "../../../modules/query/operator-query.mjs";
...
changeOrderProductRouter.put('/', verifyToken, async (req, res) => {
    if (typeof req.body === 'undefined' || req.body == null) {
        ...
        const {order_unique_id, customer_unique_id, info, is_express, products} = req.body;
        let values = [];
        if (typeof products !== 'undefined' && products != null) {
            ...
            if(values.length>0){
                await db.query(updateOrderInfo, [
                    is_express,
                    info,
                    customer_unique_id,
                    order_unique_id
